<?php
    ...
    class LeadTest extends PHPUnit_Framework_TestCase
    {
        ...
        public function setUp()
        {
            ...
            $this->model = new \AmoCRM\Models\Lead($paramsBag);
        }
        ...
        {
            $mock = $this->getMockBuilder('\AmoCRM\Models\Lead')
                ->setConstructorArgs([new \AmoCRM\Request\ParamsBag()])
                ->setMethods(['apiList'])
                ->getMock();

            $this->assertInstanceOf('\AmoCRM\Models\Lead', $mock);
